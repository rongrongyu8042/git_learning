...
import com.mars.hope.utils.ByteUtils;
...
public class UDPSearcher {
    ...
    private static final int LISTEN_PORT = PORT_CLIENT_RESPONSE;
    ...
    private static void sendBroadcast() throws IOException {
        ...
        // 设置服务器端口
        requestPacket.setPort(PORT_SERVER);
    ...
    private static class Listener extends Thread {
        ...
        private final int minLen = HEADER.length + 2 + 4;
            ...
            try {
                ...
                while (!done) {
                    ...
                    boolean isValid = dataLen >= minLen
                            && ByteUtils.startsWith(data, HEADER);
                    ...
                    ByteBuffer byteBuffer = ByteBuffer.wrap(buffer, HEADER.length, dataLen);
